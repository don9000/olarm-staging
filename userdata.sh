...
## Github Deploy Key
echo ${GITHUB_OLARM_ADMIN_DEPLOY_KEY} | base64 --decode | gunzip > ./.ssh/id_rsa_admin_github1
echo ${GITHUB_OLARM_SCHEDULER_DEPLOY_KEY} | base64 --decode | gunzip > ./.ssh/id_rsa_scheduler_github1
chmod 600 /home/ubuntu/.ssh/id_rsa_admin_github1
chmod 600 /home/ubuntu/.ssh/id_rsa_scheduler_github1
echo "Host github.com
 HostName github.com
 IdentityFile ~/.ssh/id_rsa_admin_github1
...
mkdir -p /home/ubuntu/actions-runner/_work/olarm-admin/olarm-admin
